...
<div class="container py-5">
    ...
    <div class="mb-4">
        <a href="{{ route('products.show', $product) }}" class="text-decoration-none" style="color:var(--bs-primary)">
            <i class="fa fa-arrow-left me-1"></i>Back to Product
        </a>
        <h2 class="fw-bold mt-2" style="font-family:'Raleway',sans-serif">
            <i class="fa fa-edit me-2" style="color:var(--bs-primary)"></i>Edit Product
        </h2>
    </div>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm" style="border-radius:.85rem;overflow:hidden">
                <div class="card-header border-0 py-3 px-4" style="background:var(--bs-primary)">
                ...
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('products.update', $product) }}" enctype="multipart/form-data">
                        ...
                        <div class="d-flex justify-content-end gap-2 pt-2 mt-3 border-top">
                            ...
                            <button type="submit" class="btn fw-semibold px-4" style="background:var(--bs-primary);color:#fff">
